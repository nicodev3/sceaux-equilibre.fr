    ...
    <div className="c-page-layout grid gap-10 lg:grid-cols-12">
      ...
      >
        ...
        <p>
          ...
          l&apos;inconscient font pleinement partie de cette technique. Toutefois le psychologue ou le psychanalyste y
          est plus actif qu&apos;en psychanalyse classique. Il peut proposer à son patient des explications rationnelles
          sur les processus en cours, lui exprimer un soutien plus actif, le rassurer.
        </p>
        <p>
          Pour demeurer psychanalytique, cette thérapie réclame de la part du psychologue ou du psychanalyste une
          analyse fine du transfert et du contre-tranfert qui mettra à jour les processus inconscients en oeuvre dans le
          symptôme.
        </p>
        ...
        <p>
          ...
          <cite> vil plomb de la psychothérapie</cite>. De nos jours on peut considérer que dans certaines conditions
          une psychothérapie psychanalytique est un authentique travail psychanalytique en profondeur qui donne des
          résultats durables.
        </p>
        <aside className="c-le-point-sur">
          ...
          <p>
            Malgré un rapport vivement critiqué sur le plan méthodologique datant de 2005 et depuis lors retiré du site
            du ministère, et qui présentait une supériorité des méthodes comportementales sur la psychanalyse, cette
            dernière reste à ce jour une méthode de choix dans le soin psychique.
          </p>
        </aside>
      </section>
