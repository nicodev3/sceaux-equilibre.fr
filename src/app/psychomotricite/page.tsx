...
const PsychomotricitePage = () => {
  return (
    <div>
      ...
      <p>
        Les psychomotriciens sont des auxiliaires médicaux diplômés d&apos;Etat. Cette profession en plein essor possède
        de multiples applications. Tous les âges sont concernés, de la femme enceinte jusqu&apos;à la personne âgée. Le
        champ d&apos;intervention des psychomotriciens est le suivant:
      </p>
      <div>
        ...
        <p>
          ...
          l&apos;importance et la nature d&apos;éventuels troubles psychomoteurs, mais aussi de dégager les compétences
          du sujet. C&apos;est l&apos;examen de référence du psychomotricien et il permet en outre d&apos;envisager le
        ...
        <p>
          Il s&apos;agit de tout retard anormal du développement psychomoteur. Acquisition de la marche, troubles de la
          préhension, troubles de l&apos;équilibre, de la coordination des gestes etc...
        </p>
        <p>
        ...
        <p>
          On les rencontre ici encore dans divers tableaux cliniques allant de l&apos;immaturité du système nerveux, qui
          peut avoir des origines diverses, à des difficultés d&apos;ordre psychologique qui entravent la perception de
          soi et de l&apos;espace.
        </p>
        ...
        <p>
          ...
          l&apos;écriture et de la lecture peuvent avoir pour origine une latéralité peu structurée ou mal organisée. La
          rééducation permet le plus souvent de pallier ces difficultés.
        </p>
        <h3 className={`${openSans.className}`}>Troubles de l&apos;organisation spatio-temporelle</h3>
        <p>
          Ces troubles ont diverses origines. On les rencontre à tous les âges de la vie, sous leur forme la plus banale
          et parfois bénigne chez l&apos;enfant, ou encore chez les personnes souffrant de maladies neuro-dégénératives
          telles que la maladie d&apos;Alzheimer. Le bilan psychomoteur permet d&apos;apprécier la nature et
        ...
        <p>
          ...
          psychomotrices. Ce concept est vaste et il doit ici encore être précisé par un bilan psychomoteur croisé avec
          d&apos;autres observations, à la recherche d&apos;une cause des troubles.
        </p>
        ...
        <p>
          ...
          rencontre fréquemment chez l&apos;enfant qui présente un retard de développement psychomoteur, mais aussi chez
          l&apos;adulte. Les causes, diverses, et la portée des troubles sont appréciés par le bilan psychomoteur qui
          détermine le projet thérapeutique.
        </p>
        ...
        <p>
          ...
          niveau rencontrent également parfois une difficulté dans certains gestes qu&apos;un travail en psychomotricité
          peut améliorer.
        </p>
        ...
        <p>
          ...
          les troubles liés au geste de l&apos;écriture. Mauvaise tenue du crayon ou du stylo, troubles de la régulation
          du tonus musculaire déteriorant l&apos;écriture, latéralité contrariée, difficultés de repérage dans
          l&apos;espace entravant le passage à l&apos;écrit, de nombreux facteurs entravant la réussite scolaire peuvent
          être traités en rééducation psychomotrice.
        </p>
        ...
        <p>
          ...
          des troubles caractériels ou de la personnalité, des troubles des régulations émotionnelles et relationnelles
          et des troubles de la représentation du corps d&apos;origine psychique ou physique.
        </p>
        <p>
          La thérapie psychomotrice est un facteur d&apos;intégration des sensations corporelles, des émotions et des
          cognitions. En ce sens, il s&apos;agit à proprement parler d&apos;une thérapie prenant en compte le corps dans
          sa dimension relationnelle et dans son vécu. Anxiété, stress, angoisses, dépression, troubles de la relation à
          l&apos;autre, manifestations psychosomatiques, la thérapie psychomotrice présente une alternative aux
          psychothérapies exclusivement verbales.
        </p>
      </div>
    </div>
  )
